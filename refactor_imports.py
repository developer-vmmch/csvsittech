...
# We need to drop EVERYTHING from def api_diagnosis_preview to def api_investigation_download_template (exclusive).
start_match = re.search(r"def api_diagnosis_preview\(request\):", content)
