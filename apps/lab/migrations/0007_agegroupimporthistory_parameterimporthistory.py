# Generated by Django 5.2.17 on 2026-08-25 07:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lab', '0006_agegroup_code_agegroup_gender_agegroup_is_active_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='AgeGroupImportHistory',
            fields=[
