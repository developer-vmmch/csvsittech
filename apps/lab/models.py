...
class Investigation(TimeStampedModel):
    ...
    department = models.ForeignKey('patients.Department', on_delete=models.SET_NULL, null=True, blank=True, related_name='investigations', verbose_name="Primary Department")
    departments = models.ManyToManyField('patients.Department', blank=True, related_name='investigation_set', verbose_name="Departments")
